...
#   예: name, my_name, NAME, Name, name3 (대문자는 특별한 용도가 있기 떄문에 가능한 한 안 쓰는 게 좋다.)
...
#  3. 대문자로 시작하는 변수며 예 : Car
#  4. 전체가 대문자인 변수명 예: CAR

# 좋은 변수명 : 이름만으롣 용도를 확실히 알 수 있는 변수명
...
x = 2
y = x + 10  # name 'x' is not defined. (앞줄에서 x가 정의되지 않은 경우)
print(x,y)
